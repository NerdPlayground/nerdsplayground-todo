...
#specifies how to authenticate users
AUTH_USER_MODEL= "authentication.User"

#explicitly informs django rest framework what class to use for authentication
#this will be used to protect all the views in the application by default
#Pagination:
#   ===>'DEFAULT_PAGINATION_CLASS':"rest_framework.LimitOffsetPagination"
